        ...
        public AutoMapperProfile()
        {
           ...
           .ForMember(des => des.HSCHUS, opt => opt.MapFrom(src => src.ChangedUser));
            ...
            CreateMap<MDMP, DefectMappingDto>()
                ...
                .ForMember(des => des.LineProcessGroup, opt => opt.MapFrom(src => src.DMLPGR))
                .ForMember(des => des.DefectCode, opt => opt.MapFrom(src => src.DMDFNO))
                .ForMember(des => des.DefectPosition, opt => opt.MapFrom(src => src.DMPOSD))
                .ForMember(des => des.DefectGroup, opt => opt.MapFrom(src => src.DMDPGR))
                .ForMember(des => des.DefectPostX, opt => opt.MapFrom(src => src.DMPOSX))
                .ForMember(des => des.DefectPostY, opt => opt.MapFrom(src => src.DMPOSY))
                .ForMember(des => des.Remark, opt => opt.MapFrom(src => src.DMREMA))
                .ForMember(des => des.RecordStatus, opt => opt.MapFrom(src => src.DMRCST))
                .ForMember(des => des.CreateDate, opt => opt.MapFrom(src => src.DMCRDT))
                .ForMember(des => des.CreateTime, opt => opt.MapFrom(src => src.DMCRTM))
                .ForMember(des => des.CreateUser, opt => opt.MapFrom(src => src.DMCRUS))
            ...
            CreateMap<DefectMappingDto, MDMP>()
                ...
                .ForMember(des => des.DMLPGR, opt => opt.MapFrom(src => src.LineProcessGroup))
                .ForMember(des => des.DMDFNO, opt => opt.MapFrom(src => src.DefectCode))
                .ForMember(des => des.DMPOSD, opt => opt.MapFrom(src => src.DefectPosition))
                .ForMember(des => des.DMDPGR, opt => opt.MapFrom(src => src.DefectGroup))
                .ForMember(des => des.DMPOSX, opt => opt.MapFrom(src => src.DefectPostX))
                .ForMember(des => des.DMPOSY, opt => opt.MapFrom(src => src.DefectPostY))
                .ForMember(des => des.DMREMA, opt => opt.MapFrom(src => src.Remark))
                .ForMember(des => des.DMRCST, opt => opt.MapFrom(src => src.RecordStatus))
                .ForMember(des => des.DMCRDT, opt => opt.MapFrom(src => src.CreateDate))
                .ForMember(des => des.DMCRTM, opt => opt.MapFrom(src => src.CreateTime))
                .ForMember(des => des.DMCRUS, opt => opt.MapFrom(src => src.CreateUser))
                .ForMember(des => des.DMCHDT, opt => opt.MapFrom(src => src.ChangeDate))
