...
namespace TRAINING.API.Helper
{
    public class ActiveDirectory
    {
        ...
        private string sDomain = "agc.jp";
        private string sDefaultOU = "DC=agc,DC=jp";
        // private string sDefaultRootOU = "DC=agc,DC=jp";
        private string sServiceUser = @"AID11SERSP_FARM";
        private string sServicePassword = "BD#hd+u4JKt8&66";
